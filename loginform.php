<html>
    ...
    <body>
        ...
        <!--
            1. После успешной авторизации переадресовывать на главную.
            2. После неуспешной попытке авторизации не очищать форму.
            3. При регистрации высылать токен на почту (опционно. на первое время можно обойтись переадресацией на главную страницу см. пункт 1).
            4. Добавить колонку админа.
        -->
